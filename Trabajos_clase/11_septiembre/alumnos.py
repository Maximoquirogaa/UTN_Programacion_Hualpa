...
numeros = random.sample(range(len(alumnos)),(len(alumnos)))
alumnos_mezclados = [alumnos[i] for i in numeros]
alumnos_matriz = [alumnos_mezclados [ _:(_+4)] for _ in range(0,len(alumnos_mezclados),4)]


for fila in alumnos_matriz:
    print(fila)